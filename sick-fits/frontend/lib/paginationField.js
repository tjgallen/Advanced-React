...
export default function paginationField() {
  return {
    ...
    read(existing = [], { args, cache }) {  //args are first and skip values
      ...
      // The other thing we can do is to return false from here, (this causes a network request)
    },
    merge(existing, incoming, { args }) {
      const { skip, first } = args;
      // This runs when the Apollog client comes back from the network with our products.
